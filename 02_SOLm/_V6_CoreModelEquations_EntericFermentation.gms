PUTCLOSE con,"_V6_CoreModelEquations_EntericFermentation";

*GENERAL DESCRIPTION
*This file contains all the core model equations for calculating enteric fermentation emissions
...
*ATTENTION: later convert to detailed feeding rations - i.e. GE supply per commodity fed to animals (as parameter FeedingRations with animal and commodity dimension, instead of per animal head par) * times CH4 conversion factor
...
FeedingRationsHeads_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"AggregateFeedTotal_Commodity","Percentage GE in feed converted to enteric CH4",ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = (ActAnimalsHead_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"FeedGE_Req_Total from Conc (MJ)",ProductionSystems,ProductionConditions,"%Scenario%")
                 *FeedingRationsHeads_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"AggregateFeedConcentrates_Commodity","Percentage GE in feed converted to enteric CH4",ProductionSystems,ProductionConditions,"%Scenario%")
         + ActAnimalsHead_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"FeedGE_Req_Total from Forage (MJ)",ProductionSystems,ProductionConditions,"%Scenario%")
                 *FeedingRationsHeads_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Percentage GE in feed converted to enteric CH4",ProductionSystems,ProductionConditions,"%Scenario%")
         + ActAnimalsHead_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"FeedGE_Req_Total from Grass (MJ)",ProductionSystems,ProductionConditions,"%Scenario%")
                 *FeedingRationsHeads_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"AggregateFeedGrass_Commodity","Percentage GE in feed converted to enteric CH4",ProductionSystems,ProductionConditions,"%Scenario%")
         + ActAnimalsHead_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"FeedGE_Req_Total from Residues (MJ)",ProductionSystems,ProductionConditions,"%Scenario%")
                 *FeedingRationsHeads_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"AggregateFeedResidues_Commodity","Percentage GE in feed converted to enteric CH4",ProductionSystems,ProductionConditions,"%Scenario%"))
         /ActAnimalsHead_OtherChar_MR(Regions_MR,Activities_MR,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"%Scenario%");
