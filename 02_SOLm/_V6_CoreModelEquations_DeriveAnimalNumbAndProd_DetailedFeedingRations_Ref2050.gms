PUTCLOSE con,"_V6_CoreModelEquations_DeriveAnimalNumbAndProd_DetailedFeedingRations_Ref2050";
...
*$label EndAuxVarDef
*here, we need this for FOFA_BAU_2050
AUX_Inverse_VActAnimalsHead_Outputs_MR.l(Regions_MR,Activities,AnimalTypeInHerd,OutputsAnimals,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VActAnimalsHead_Outputs_MR.l(Regions_MR,Activities,AnimalTypeInHerd,OutputsAnimals,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VActAnimalsHead_Outputs_MR.l(Regions_MR,Activities,AnimalTypeInHerd,OutputsAnimals,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VCommod_Production_MR.l(Regions_MR,Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = sum((Activities,AnimalTypeInHerd,OutputsAnimals)$MatchCommAct_CommoditiesDAQ_TradeFTW_AnimalsPrimaryGrassFed(Commodities_MR,Activities,OutputsAnimals),
                  VCommod_Production_MR.l(Regions_MR,Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_GrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         ...
         = VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_GrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                 $((VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                 + VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
         ...
         = VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
*for FOFA_BAU_2050:
VCommod_Quantity_MR.l(Regions_MR,"Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = VCommod_Quantity_MR.l(Regions_MR,"Milk, whole",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
           + VCommod_Production_MR.l(Regions_MR,"Milk, whole fresh buffalo",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
           + VCommod_Production_MR.l(Regions_MR,"Milk, whole fresh cow",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
           + VCommod_Production_MR.l(Regions_MR,"Milk, whole fresh goat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
           + VCommod_Production_MR.l(Regions_MR,"Milk, whole fresh sheep",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
*
...
*here, we need this for FOFA_BAU_2050
AUX_Inverse_VCommod_Quantity_MR.l(Regions_MR,"Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VCommod_Quantity_MR.l(Regions_MR,"Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VCommod_Quantity_MR.l(Regions_MR,"Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = sum(Commodities_MR_2$MatchPrimDerivedCommodities_DAQ_TradeFTW_AnimalsDer_GrassFed(CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,Commodities_MR_2),
                 VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *VCommod_Quantity_MR.l(Regions_MR,Commodities_MR_2,ProductionSystems,ProductionConditions,"%Scenario%")
                                 *AUX_Inverse_VCommod_Quantity_MR.l(Regions_MR,Commodities_MR_2,"AllProdSyst",ProductionConditions,"FOFA_BAU_2050"));
...
*for FOFA_BAU_2050:
VExportQuantity_MR.l(Regions_MR,"World","Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = VExportQuantity_MR.l(Regions_MR,"World","Milk, whole",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
           + VExportQuantity_MR.l(Regions_MR,"World","Milk, whole fresh buffalo",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
           + VExportQuantity_MR.l(Regions_MR,"World","Milk, whole fresh cow",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
           + VExportQuantity_MR.l(Regions_MR,"World","Milk, whole fresh goat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
           + VExportQuantity_MR.l(Regions_MR,"World","Milk, whole fresh sheep",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
*Here, we need this for FOFA_BAU_2050
AUX_Inverse_VExportQuantity_MR.l("World","World","Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VExportQuantity_MR.l("World","World","Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VExportQuantity_MR.l("World","World","Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
*scale by the import scale factor, as the global export stands for the potential to import the source commodity for production of this: if imports are rather reduced in a scenario, this should be reflected here as well.
                         ...
                         *VExportQuantity_MR.l("World","World",Commodities_MR_2,ProductionSystems,ProductionConditions,"%Scenario%")
                                 *AUX_Inverse_VExportQuantity_MR.l("World","World",Commodities_MR_2,"AllProdSyst",ProductionConditions,"FOFA_BAU_2050"));
...
VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         ...
         = VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                   *ImportScaleFactor_MR(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                 *VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                         /VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Animals_GrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VCommod_Quantity_MR.l(Regions_MR,"Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050") = 0;
VExportQuantity_MR.l(Regions_MR,"World","Milk",ProductionSystems,ProductionConditions,"%Scenario%") = 0;
VExportQuantity_MR.l(Regions_MR,"World","Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050") = 0;
...
VCommod_Quantity_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorld_FishSeafood,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VCommod_Quantity_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorld_FishSeafood,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorld_FishSeafood,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorld_FishSeafood,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
*LABEL MADAGASCAR-correction - to be checked and improved!!
*AD HOC problem fix
*there aere some problems with countries not reporting enough feed after having fed ruminants in 2050 - this is the case for Madagascar, for example, resulting in very low values for
*VCommod_Feed_Contents_MR.l(Regions_MR,"AggregateFeedCereals_Commodity","FeedQuant DM (t) - left after feeding ruminants",ProductionSystems,ProductionConditions,"%Scenario%")
*which then blows up pig and chicken numbers such as to disrupt all results.
*hence replace with baseline values in this case:
Commod_OtherChar_MR(Regions_MR,"AggregateFeedCereals_Commodity","Feed DM supply/demand ratio - left after feeding ruminants",ProductionSystems,ProductionConditions,"%Scenario%")
                 $(Commod_OtherChar_MR(Regions_MR,"AggregateFeedCereals_Commodity","Feed DM supply/demand ratio - left after feeding ruminants",ProductionSystems,ProductionConditions,"%Scenario%")
                         AND (Commod_OtherChar_MR(Regions_MR,"AggregateFeedCereals_Commodity","Feed DM supply/demand ratio - left after feeding ruminants",ProductionSystems,ProductionConditions,"%Scenario%") < 0.05))
         = Commod_OtherChar_MR(Regions_MR,"AggregateFeedCereals_Commodity","Feed DM supply/demand ratio - left after feeding ruminants","AllProdSyst",ProductionConditions,"BaselineDerived");
*LABEL MADAGASCAR-correction - to be checked and improved!!
...
*Here, we need this for FOFA_BAU_2050
AUX_Inverse_VActCropsGrass_QuantityActUnits_MR.l(Regions,"PollinatedCrops",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VActCropsGrass_QuantityActUnits_MR.l(Regions,"PollinatedCrops",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1 / VActCropsGrass_QuantityActUnits_MR.l(Regions,"PollinatedCrops",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VActAnimalsAPU_QuantityActUnits_MR.l(Regions,Activities,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VActAnimalsAPU_QuantityActUnits_MR.l(Regions,Activities,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 *VActCropsGrass_QuantityActUnits_MR.l(Regions,"PollinatedCrops",ProductionSystems,ProductionConditions,"%Scenario%")
                         *AUX_Inverse_VActCropsGrass_QuantityActUnits_MR.l(Regions,"PollinatedCrops",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");

*set these aggregates and aux variables equal zero again
VActCropsGrass_QuantityActUnits_MR.l(Regions,"PollinatedCrops",ProductionSystems,ProductionConditions,"FOFA_BAU_2050") = 0;
VActCropsGrass_QuantityActUnits_MR.l(Regions,"PollinatedCrops",ProductionSystems,ProductionConditions,"%Scenario%") = 0;
AUX_Inverse_VActCropsGrass_QuantityActUnits_MR.l(Regions,"PollinatedCrops",ProductionSystems,ProductionConditions,"FOFA_BAU_2050") = 0;
...
VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         ...
         = VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                 $((VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                 + VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
         ...
         = VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
*Here, we need this for FOFA_BAU_2050
AUX_Inverse_VCommod_Quantity_MR.l(Regions_MR,"Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VCommod_Quantity_MR.l(Regions_MR,"Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VCommod_Quantity_MR.l(Regions_MR,"Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = sum(Commodities_MR_2$MatchPrimDerivedCommodities_DAQ_TradeFromToWorld_AnimalsDerived(CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,Commodities_MR_2),
                 VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *VCommod_Quantity_MR.l(Regions_MR,Commodities_MR_2,ProductionSystems,ProductionConditions,"%Scenario%")
                                 *AUX_Inverse_VCommod_Quantity_MR.l(Regions_MR,Commodities_MR_2,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"));
...
*Here, we need thios for FOFA_BAU_2050
AUX_Inverse_VExportQuantity_MR.l("World","World","Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VExportQuantity_MR.l("World","World","Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VExportQuantity_MR.l("World","World","Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
*scale by the import scale factor, as the global export stands for the potential to import the source commodity for production of this: if imports are rather reduced in a scenario, this should be reflected here as well.
                         ...
                         *VExportQuantity_MR.l("World","World",Commodities_MR_2,ProductionSystems,ProductionConditions,"%Scenario%")
                                 *AUX_Inverse_VExportQuantity_MR.l("World","World",Commodities_MR_2,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"));
...
VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         ...
         = VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                   *ImportScaleFactor_MR(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                 *VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
                         /VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFTWDirDerFromPrim_Anim_NonGrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VCommod_Quantity_MR.l(Regions_MR,"Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050") = 0;
VCommod_Quantity_MR.l(Regions_MR,"Milk",ProductionSystems,ProductionConditions,"%Scenario%") = 0;
VCommod_Quantity_MR.l(Regions_MR,"Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050") = 0;
VExportQuantity_MR.l(Regions_MR,"World","Meat",ProductionSystems,ProductionConditions,"%Scenario%") = 0;
VExportQuantity_MR.l(Regions_MR,"World","Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050") = 0;
VExportQuantity_MR.l(Regions_MR,"World","Milk",ProductionSystems,ProductionConditions,"%Scenario%") = 0;
VExportQuantity_MR.l(Regions_MR,"World","Milk",ProductionSystems,ProductionConditions,"FOFA_BAU_2050") = 0;
...
*NEW
                 $(VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         AND (NOT (VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                               + VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))))
*condition not needed and not possible - as from the first iteration all values are here already!
*                         AND (NOT VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"%Scenario%")))
         = VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimaryAnimals_NongrassFed,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
*                 $VExportQuantity_MR.l("World","World","Meat",ProductionSystems,ProductionConditions,"Baseline")
*         = 1/VExportQuantity_MR.l("World","World","Meat",ProductionSystems,ProductionConditions,"Baseline");
*Here, we need it for FOFA_BAU_2050
AUX_Inverse_VExportQuantity_MR.l("World","World","Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VExportQuantity_MR.l("World","World","Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VExportQuantity_MR.l("World","World","Meat",ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
****************************************************************************************************************************************************************************************************
****************************************************************************************************************************************************************************************************
*14) Adjust total exports such as to be in the same relation as in the reference 2050:

*This code is used to adjust total global exports such as to have the same ratio over total global imports as in the reference.
*This is needed in case imports are specified in the scenario specifications, e.g. via scaling factors not equal to 1, as this does not fully translate to accordingly changed exports. DAQ of exporting countries is then accordingly adapted as well.
...
AUX_VExportQuantity_MR.l("Regions - no exp scaling","World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
         =sum(Regions_NoExportScaling,VExportQuantity_MR.l(Regions_NoExportScaling,"World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%"));
AUX_VExportQuantity_MR.l("Regions - with exp scaling","World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
         =sum(Regions_WithExportScaling,VExportQuantity_MR.l(Regions_WithExportScaling,"World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%"));


Commod_OtherChar_MR("World",Commodities_MR,"Global Exp/Imp corr factor - no exp-scaling for some Regions",ProductionSystems,ProductionConditions,"%Scenario%")
                 $(Commod_OtherChar_MR("World",Commodities_MR,"Global Export/Import ratio",ProductionSystems,ProductionConditions,"%Scenario%")
                         AND AUX_VExportQuantity_MR.l("Regions - with exp scaling","World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%"))
         = ((Commod_OtherChar_MR("World",Commodities_MR,"Global Export/Import ratio",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 /Commod_OtherChar_MR("World",Commodities_MR,"Global Export/Import ratio",ProductionSystems,ProductionConditions,"%Scenario%"))
                         *AUX_VExportQuantity_MR.l("World","World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
                                 - AUX_VExportQuantity_MR.l("Regions - no exp scaling","World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%"))
                                         /AUX_VExportQuantity_MR.l("Regions - with exp scaling","World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%");
...
VExportQuantity_MR.l(Regions_WithExportScaling,"World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
         = VExportQuantity_MR.l(Regions_WithExportScaling,"World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
                 *Commod_OtherChar_MR("World",Commodities_MR,"Global Exp/Imp corr factor - no exp-scaling for some Regions",ProductionSystems,ProductionConditions,"%Scenario%");

VCommod_Quantity_MR.l(Regions_WithExportScaling,Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
                 $Commod_OtherChar_MR("World",Commodities_MR,"Global Exp/Imp corr factor - no exp-scaling for some Regions",ProductionSystems,ProductionConditions,"%Scenario%")
         = VCommod_Quantity_MR.l(Regions_WithExportScaling,Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
                 + VExportQuantity_MR.l(Regions_WithExportScaling,"World",Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
                         /Commod_OtherChar_MR("World",Commodities_MR,"Global Exp/Imp corr factor - no exp-scaling for some Regions",ProductionSystems,ProductionConditions,"%Scenario%")
...
*Regions_NoExportScaling: no adjustment needed
...
*Drop the following - anyway not run as this module is not run for FOFA_BAU_2050
*(for this scenario, the module wihtout _Ref2050 is run as the reference for the FOFA_BAU_2050 trade calculations are the Baseline, as onyl there trade for 2050 is derived - which is then used as a reference for other scenarios, such as FOFA_BAU_2050_Test, done here).
...
VExportQuantity_MR.l(Regions_MR,Regions_MR_2,Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = sum((Activities,OutputsAnimals,ProducingAnimals)$(MatchCommAct_ComplexAnimalCommodities(Commodities_MR,Activities,OutputsAnimals)
                         AND VActAnimalsHead_Outputs_MR.l(Regions_MR,Activities,ProducingAnimals,OutputsAnimals,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")),
                 VExportQuantity_MR.l(Regions_MR,Regions_MR_2,Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *VActAnimalsHead_Outputs_MR.l(Regions_MR,Activities,ProducingAnimals,OutputsAnimals,ProductionSystems,ProductionConditions,"%Scenario%")
                                 /VActAnimalsHead_Outputs_MR.l(Regions_MR,Activities,ProducingAnimals,OutputsAnimals,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"));
...
VImportQuantity_MR.l(Regions_MR,Regions_MR_2,Commodities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = sum((Activities,OutputsAnimals,ProducingAnimals)$(MatchCommAct_ComplexAnimalCommodities(Commodities_MR,Activities,OutputsAnimals)
                         AND VActAnimalsHead_Outputs_MR.l(Regions_MR_2,Activities,ProducingAnimals,OutputsAnimals,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")),
                 VImportQuantity_MR.l(Regions_MR,Regions_MR_2,Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *VActAnimalsHead_Outputs_MR.l(Regions_MR_2,Activities,ProducingAnimals,OutputsAnimals,ProductionSystems,ProductionConditions,"%Scenario%")
                                 /VActAnimalsHead_Outputs_MR.l(Regions_MR_2,Activities,ProducingAnimals,OutputsAnimals,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"));
