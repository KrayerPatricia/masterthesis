PUTCLOSE con,"_V6_CoreModelEquations_FertilizerApplicationEmissions";
...
ActCropsGrass_Inputs_MR(Regions_MR,Activities_MR,"N deposition (tN)",ProductionSystems,ProductionConditions,"%Scenario%")
                         $(VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,Activities_MR,ProductionSystems,ProductionConditions,"%Scenario%")
                              AND (VActCropsGrass_Outputs_MR.l(Regions_MR,"All crops and grass","N volat from mineral fert N applic (tN)","AllProdSyst","AllProdCond","BaselineDerived")
                                         +VActCropsGrass_Outputs_MR.l(Regions_MR,"All crops and grass","N volat from CropRes/biomass as fert N applic (tN)","AllProdSyst","AllProdCond","BaselineDerived")
                                         +VActCropsGrass_Outputs_MR.l(Regions_MR,"All crops and grass","N volat from manure as fert N applic (tN)","AllProdSyst","AllProdCond","BaselineDerived")
                                         +VActAnimalsHead_Outputs_MR.l(Regions_MR,"All animals","AllAndAverageTypes","Manure man N volat (tN)","AllProdSyst","AllProdCond","BaselineDerived")))
         = ActCropsGrass_Inputs_MR(Regions_MR,Activities_MR,"N deposition (tN)","AllProdSyst",ProductionConditions,"BaselineDerived")
                                  *0.2
                 + ActCropsGrass_Inputs_MR(Regions_MR,Activities_MR,"N deposition (tN)","AllProdSyst",ProductionConditions,"BaselineDerived")
                                 *0.8
                         *(VActCropsGrass_Outputs_MR.l(Regions_MR,"All crops and grass","N volat from mineral fert N applic (tN)","AllProdSyst","AllProdCond","%Scenario%")
                                 ...
                                 +VActCropsGrass_Outputs_MR.l(Regions_MR,"All crops and grass","N volat from manure as fert N applic (tN)","AllProdSyst","AllProdCond","%Scenario%")
                                 +VActAnimalsHead_Outputs_MR.l(Regions_MR,"All animals","AllAndAverageTypes","Manure man N volat (tN)","AllProdSyst","AllProdCond","%Scenario%"))
                         /(VActCropsGrass_Outputs_MR.l(Regions_MR,"All crops and grass","N volat from mineral fert N applic (tN)","AllProdSyst","AllProdCond","BaselineDerived")
                                 +VActCropsGrass_Outputs_MR.l(Regions_MR,"All crops and grass","N volat from CropRes/biomass as fert N applic (tN)","AllProdSyst","AllProdCond","BaselineDerived")
                                 +VActCropsGrass_Outputs_MR.l(Regions_MR,"All crops and grass","N volat from manure as fert N applic (tN)","AllProdSyst","AllProdCond","BaselineDerived")
                                 +VActAnimalsHead_Outputs_MR.l(Regions_MR,"All animals","AllAndAverageTypes","Manure man N volat (tN)","AllProdSyst","AllProdCond","BaselineDerived"));
