PUTCLOSE con,"_V6_DataDerived_CropProductionTotalsAndDAQ_Ref2050";
...
AUX_Inverse_VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimary,ProductionSystems,ProductionConditions,"%Scenario%")
                 $((VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFromToWorldPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                           - VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
         ...
         = VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimary,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
*$label EndAuxVarDef2
*here, we need it for FOFA_BAU_2050
AUX_Inverse_VCommod_Quantity_MR.l(Regions_MR,Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VCommod_Quantity_MR.l(Regions_MR,Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VCommod_Quantity_MR.l(Regions_MR,Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = sum(Commodities_MR_2$MatchPrimDerivedCommodities_DAQ_TradeFromToWorld_CropsDerived(CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,Commodities_MR_2),
                 VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
*here, we need bot these for FOFA_BAU_2050:
VExportQuantity_MR.l("World","World",Commodities,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         =sum(Regions_MR,VExportQuantity_MR.l(Regions_MR,"World",Commodities,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"));

AUX_Inverse_VExportQuantity_MR.l("World","World",Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 $VExportQuantity_MR.l("World","World",Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         = 1/VExportQuantity_MR.l("World","World",Commodities_MR,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
*scale by the import scale factor, as the global export stands for the potential to import the source commodity for production of this: if imports are rather reduced in a scenario, this should be reflected here as well.
                         ...
                         *(VExportQuantity_MR.l("World","World",Commodities_MR_2,ProductionSystems,ProductionConditions,"%Scenario%")
                                 ...
                                 *AUX_Inverse_VExportQuantity_NotFromCountry_MR.l(Regions_MR,"World",Commodities_MR_2,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"));
...
VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"%Scenario%")
                 $((VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                 - VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
         ...
         = VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                   *ImportScaleFactor_MR(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"%Scenario%")
                 *(VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"%Scenario%")
                                 - VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"%Scenario%"))
                         /(VCommod_Production_MR.l("World",CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldDirectlyDerivedFromPrimary,Productionsystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = sum((Activities,OutputsCropsGrass)$MatchCommAct_CommodDAQ_TradeFTWorld_CropCommodAndProducts(CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,Activities,OutputsCropsGrass),
                  VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *AUX_BaselineProdLargerThanExports_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
*part with the absolute value: to only retain if exports are larger than production; otherwise it would become negative; then scale this part of texports that are larger than prod with the produciton abroad without domestic production
*thus:
VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
         $((NOT VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%"))
*                 AND VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
)
         = (    (VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         - sum((Activities,OutputsCropsGrass)$MatchCommAct_CommodDAQ_TradeFTWorld_CropCommodAndProducts(CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,Activities,OutputsCropsGrass),
                                 VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")))
           +abs((VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         - sum((Activities,OutputsCropsGrass)$MatchCommAct_CommodDAQ_TradeFTWorld_CropCommodAndProducts(CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,Activities,OutputsCropsGrass),
                                 VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))))   )/2
                                           *ExportScaleFactor_MR(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
*scale in addition by the import scale factor, as the global production stands for the potential to import the source commodity for production of this: if imports are rather reduced in a scenario, this should be reflected here as well.
                                   *ImportScaleFactor_MR(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
                 *sum((Activities,OutputsCropsGrass)$(MatchCommAct_CommodDAQ_TradeFTWorld_CropCommodAndProducts(CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,Activities,OutputsCropsGrass)
                                 AND (VActCropsGrass_Outputs_MR.l("World",Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                         - VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))),
                         (VActCropsGrass_Outputs_MR.l("World",Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"%Scenario%")
                                         - VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"%Scenario%"))
                                 /(VActCropsGrass_Outputs_MR.l("World",Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                         - VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")))
...
VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VExportQuantity_MR.l("World","World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         ...
         = VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                                   *ImportScaleFactor_MR(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
                 *VExportQuantity_MR.l("World","World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
                          /VExportQuantity_MR.l("World","World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
AUX_ProdPlusImport_VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
         =sum((Activities,OutputsCropsGrass)$MatchCommAct_CommodDAQ_TradeFTWorld_CropCommodAndProducts(CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,Activities,OutputsCropsGrass),
                 VActCropsGrass_Outputs_MR.l(Regions_MR,Activities,OutputsCropsGrass,ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
                         + VImportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 *AUX_ProdPlusImport_VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"%Scenario%")
                         /AUX_ProdPlusImport_VCommod_Production_MR.l(Regions_MR,CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"FOFA_BAU_2050");
...
VCommod_Production_MR.l(Regions_MR,"Beer",ProductionSystems,ProductionConditions,"%Scenario%")
                 $((VCommod_Quantity_MR.l(Regions_MR,"Barley and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *Commod_OtherChar_MR(Regions_MR,"Barley and products","Util food (share)","AllProdSyst",ProductionConditions,"FOFA_BAU_2050"))
                    AND (NOT VCommod_Production_MR.l(Regions_MR,"Beer",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VCommod_Production_MR.l(Regions_MR,"Beer",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VImportQuantity_MR.l(Regions_MR,"World","Beer",ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World","Beer",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         AND (NOT VImportQuantity_MR.l(Regions_MR,"World","Beer",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VImportQuantity_MR.l(Regions_MR,"World","Beer",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World","Beer",ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World","Beer",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VCommod_Production_MR.l(Regions_MR,"Sweeteners, Other",ProductionSystems,ProductionConditions,"%Scenario%")
                 $((VCommod_Quantity_MR.l(Regions_MR,"Cereals, Other",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Rice (Paddy Equivalent)",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Barley and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Maize and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Wheat and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Sweet potatoes",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Yams",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Roots, Other",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Potatoes and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Molasses",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"sugar cane",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"sugar beet",ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
                    AND (NOT VCommod_Production_MR.l(Regions_MR,"Sweeteners, Other",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VCommod_Production_MR.l(Regions_MR,"Sweeteners, Other",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VImportQuantity_MR.l(Regions_MR,"World","Sweeteners, Other",ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World","Sweeteners, Other",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         AND (NOT VImportQuantity_MR.l(Regions_MR,"World","Sweeteners, Other",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VImportQuantity_MR.l(Regions_MR,"World","Sweeteners, Other",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World","Sweeteners, Other",ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World","Sweeteners, Other",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VCommod_Production_MR.l(Regions_MR,"Beverages, Fermented",ProductionSystems,ProductionConditions,"%Scenario%")
                 $((VCommod_Quantity_MR.l(Regions_MR,"Wheat and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *Commod_OtherChar_MR(Regions_MR,"Wheat and products","Util food (share)","AllProdSyst",ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Rice (Paddy Equivalent)",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Maize and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *Commod_OtherChar_MR(Regions_MR,"Maize and products","Util food (share)","AllProdSyst",ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Millet and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Sorghum and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Apples and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
                    AND (NOT VCommod_Production_MR.l(Regions_MR,"Beverages, Fermented",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VCommod_Production_MR.l(Regions_MR,"Beverages, Fermented",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 *(VCommod_Quantity_MR.l(Regions_MR,"Wheat and products",ProductionSystems,ProductionConditions,"%Scenario%")
...
VImportQuantity_MR.l(Regions_MR,"World","Beverages, Fermented",ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World","Beverages, Fermented",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         AND (NOT VImportQuantity_MR.l(Regions_MR,"World","Beverages, Fermented",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VImportQuantity_MR.l(Regions_MR,"World","Beverages, Fermented",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World","Beverages, Fermented",ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World","Beverages, Fermented",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VCommod_Production_MR.l(Regions_MR,"Beverages, Alcoholic",ProductionSystems,ProductionConditions,"%Scenario%")
                $((VCommod_Quantity_MR.l(Regions_MR,"Barley and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  ...
                  +VCommod_Quantity_MR.l(Regions_MR,"Millet and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Rice (Paddy Equivalent)",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Rye and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Sorghum and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Wheat and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         *Commod_OtherChar_MR(Regions_MR,"Wheat and products","Util food (share)","AllProdSyst",ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Cassava and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Potatoes and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Roots, Other",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Sweet potatoes",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"sugar beet",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"sugar cane",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Apples and products",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Fruits, Other",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                  +VCommod_Quantity_MR.l(Regions_MR,"Grapes and products (excl wine)",ProductionSystems,ProductionConditions,"FOFA_BAU_2050"))
                    AND (NOT VCommod_Production_MR.l(Regions_MR,"Beverages, Alcoholic",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VCommod_Production_MR.l(Regions_MR,"Beverages, Alcoholic",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 *(VCommod_Quantity_MR.l(Regions_MR,"Barley and products",ProductionSystems,ProductionConditions,"%Scenario%")
                         *Commod_OtherChar_MR(Regions_MR,"Barley and products","Util food (share)",ProductionSystems,ProductionConditions,"%Scenario%")
                  +VCommod_Quantity_MR.l(Regions_MR,"Cereals, Other",ProductionSystems,ProductionConditions,"%Scenario%")
                  +VCommod_Quantity_MR.l(Regions_MR,"Maize and products",ProductionSystems,ProductionConditions,"%Scenario%")
...
VImportQuantity_MR.l(Regions_MR,"World","Beverages, Alcoholic",ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World","Beverages, Alcoholic",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         AND (NOT VImportQuantity_MR.l(Regions_MR,"World","Beverages, Alcoholic",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VImportQuantity_MR.l(Regions_MR,"World","Beverages, Alcoholic",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World","Beverages, Alcoholic",ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World","Beverages, Alcoholic",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VCommod_Production_MR.l(Regions_MR,"Alcohol, Non-Food",ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VCommod_Production_MR.l(Regions_MR,"Alcohol, Non-Food",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                 *(VCommod_Quantity_MR.l(Regions_MR,"Barley and products",ProductionSystems,ProductionConditions,"%Scenario%")
                  +VCommod_Quantity_MR.l(Regions_MR,"Cereals, Other",ProductionSystems,ProductionConditions,"%Scenario%")
                  +VCommod_Quantity_MR.l(Regions_MR,"Maize and products",ProductionSystems,ProductionConditions,"%Scenario%")
                  +VCommod_Quantity_MR.l(Regions_MR,"Millet and products",ProductionSystems,ProductionConditions,"%Scenario%")
...
VImportQuantity_MR.l(Regions_MR,"World","Alcohol, Non-Food",ProductionSystems,ProductionConditions,"%Scenario%")
                 $(VCommod_Production_MR.l("World","Alcohol, Non-Food",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
                         AND (NOT VImportQuantity_MR.l(Regions_MR,"World","Alcohol, Non-Food",ProductionSystems,ProductionConditions,"%Scenario%")))
         = VImportQuantity_MR.l(Regions_MR,"World","Alcohol, Non-Food",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
VExportQuantity_MR.l(Regions_MR,"World","Alcohol, Non-Food",ProductionSystems,ProductionConditions,"%Scenario%")
         ...
         = VExportQuantity_MR.l(Regions_MR,"World","Alcohol, Non-Food",ProductionSystems,ProductionConditions,"FOFA_BAU_2050")
...
****************************************************************************************************************************************************************************************************
****************************************************************************************************************************************************************************************************
*3) Adjust total exports such as to be in the same relation as in the reference:
...
*execute_unload 'Test_Commod_Ref2050'
*VCommod_Contents_MR
*;
*XXXXXXXXXXXXXXXX kray: added here

*XXXXXXX kray: calculate here nutrient production (not DAQ)
