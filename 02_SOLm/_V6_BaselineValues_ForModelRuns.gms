PUTCLOSE con,"_V6_BaselineValues_ForModelRuns";

*GENERAL DESCRIPTION
*This file contains the derivations of certain baseline values we need for the model runs
...
AUX_Inverse_VExportQuantity_NotFromCountry_MR.l(Regions_MR,"World",Commodities_MR,ProductionSystems,ProductionConditions,"Baseline")
                 $(VExportQuantity_MR.l("World","World",Commodities_MR,ProductionSystems,ProductionConditions,"Baseline")
                         - VExportQuantity_MR.l(Regions_MR,"World",Commodities_MR,ProductionSystems,ProductionConditions,"Baseline"))
         = 1/(VExportQuantity_MR.l("World","World",Commodities_MR,ProductionSystems,ProductionConditions,"Baseline")
                 - VExportQuantity_MR.l(Regions_MR,"World",Commodities_MR,ProductionSystems,ProductionConditions,"Baseline"));
...
AUX_BaselineProdLargerThanExports_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"Baseline")
         = (1 - sign(VExportQuantity_MR.l(Regions_MR,"World",CommoditiesDAQ_TradeFromToWorldCropCommodAndProducts,ProductionSystems,ProductionConditions,"Baseline")
...
VCommod_Feed_MR.l(Regions,Commodities_2,ProductionSystems,ProductionConditions,"Baseline")
                 $(NOT VCommod_Feed_MR.l(Regions,Commodities_2,ProductionSystems,ProductionConditions,"Baseline"))
...
VCommod_Feed_Contents_MR.l(Regions,Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_MR.l(Regions,Commodities,ProductionSystems,ProductionConditions,"Baseline")
                 *Commod_Contents_MR(Regions,Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline");
VCommod_Feed_Contents_MR.l(Regions,Commodities,"FeedME (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_MR.l(Regions,Commodities,ProductionSystems,ProductionConditions,"Baseline")
                 *Commod_Contents_MR(Regions,Commodities,"FeedME (MJ)",ProductionSystems,ProductionConditions,"Baseline");
VCommod_Feed_Contents_MR.l(Regions,Commodities,"FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_MR.l(Regions,Commodities,ProductionSystems,ProductionConditions,"Baseline")
                 *Commod_Contents_MR(Regions,Commodities,"FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline");
VCommod_Feed_Contents_MR.l(Regions,Commodities,"FeedXP (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_MR.l(Regions,Commodities,ProductionSystems,ProductionConditions,"Baseline")
                 *Commod_Contents_MR(Regions,Commodities,"FeedXP (t)",ProductionSystems,ProductionConditions,"Baseline");
*and again summed over feed groups:
VCommod_Feed_Contents_MR.l(Regions,Commodities_2,Contents,ProductionSystems,ProductionConditions,"Baseline")
                 $(NOT VCommod_Feed_Contents_MR.l(Regions,Commodities_2,Contents,ProductionSystems,ProductionConditions,"Baseline"))
         = sum(Commodities$Match_FeedCommoditiesToFeedCommodGroups_MainByprodConc(Commodities,Commodities_2),
                 VCommod_Feed_Contents_MR.l(Regions,Commodities,Contents,ProductionSystems,ProductionConditions,"Baseline"));
*and add the main and byprod concentrates:
VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedConcentrates_Commodity",Contents,ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedConcMainProd_Commodity",Contents,ProductionSystems,ProductionConditions,"Baseline")
                 + VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedConcByProd_Commodity",Contents,ProductionSystems,ProductionConditions,"Baseline");

*and summed for the total:
*New: kray (according to change from Adrian 10.08.2021)
VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedTotal_Commodity",Contents,ProductionSystems,ProductionConditions,"Baseline")
                 $(NOT VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedTotal_Commodity",Contents,ProductionSystems,ProductionConditions,"Baseline"))
         = sum(Commodities,
                 VCommod_Feed_Contents_MR.l(Regions,Commodities,Contents,ProductionSystems,ProductionConditions,"Baseline"));

*Feed GE and XP contents per DM
*derive Feed GE and XP contents per DM for the feed commodities, feed groups and total feed:
Commod_Contents_MR(Regions,Commodities,"FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 $VCommod_Feed_Contents_MR.l(Regions,Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities,"FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VCommod_Feed_Contents_MR.l(Regions,Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline");

Commod_Contents_MR(Regions,Commodities,"FeedXP in DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                 $VCommod_Feed_Contents_MR.l(Regions,Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities,"FeedXP (t)",ProductionSystems,ProductionConditions,"Baseline")
                 /VCommod_Feed_Contents_MR.l(Regions,Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline");

*feed groups separately, as they are usually not part of Commodities_MR
Commod_Contents_MR(Regions,Commodities_FeedGroups,"FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 $VCommod_Feed_Contents_MR.l(Regions,Commodities_FeedGroups,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities_FeedGroups,"FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VCommod_Feed_Contents_MR.l(Regions,Commodities_FeedGroups,"DM (t)",ProductionSystems,ProductionConditions,"Baseline");

Commod_Contents_MR(Regions,Commodities_FeedGroups,"FeedXP in DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                 $VCommod_Feed_Contents_MR.l(Regions,Commodities_FeedGroups,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities_FeedGroups,"FeedXP (t)",ProductionSystems,ProductionConditions,"Baseline")
                 /VCommod_Feed_Contents_MR.l(Regions,Commodities_FeedGroups,"DM (t)",ProductionSystems,ProductionConditions,"Baseline");
...
ActAnimalsHead_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"FeedDM_Req_Total (t DM)",ProductionSystems,ProductionConditions,"Baseline")
                 $Commod_Contents_MR(Regions,"AggregateFeedTotal_Commodity","FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = ActAnimalsHead_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /Commod_Contents_MR(Regions,"AggregateFeedTotal_Commodity","FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline");


*first, per country demand:
VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Conc (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         =sum((Livestock,AnimalTypeInHerd),
                 VActAnimalsHead_QuantityActUnits_MR.l(Regions,Livestock,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
                         *ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                                 *FeedingRations_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"AggregateFeedConcentrates_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"));
VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Forage (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         =sum((Livestock,AnimalTypeInHerd),
                 VActAnimalsHead_QuantityActUnits_MR.l(Regions,Livestock,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
                         *ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                                 *FeedingRations_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"));
VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Grass (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         =sum((Livestock,AnimalTypeInHerd),
                 VActAnimalsHead_QuantityActUnits_MR.l(Regions,Livestock,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
                         *ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                                 *FeedingRations_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"AggregateFeedGrass_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"));
VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Residues (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         =sum((Livestock,AnimalTypeInHerd),
                 VActAnimalsHead_QuantityActUnits_MR.l(Regions,Livestock,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
                         *ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                                 *FeedingRations_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"AggregateFeedResidues_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"));

VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         =sum((Livestock,AnimalTypeInHerd),
                 VActAnimalsHead_QuantityActUnits_MR.l(Regions,Livestock,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
                         *ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline"));


Commod_OtherChar_MR(Regions,"AggregateFeedConcentrates_Commodity","Feed GE supply/demand ratio Conc",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Conc (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedConcentrates_Commodity","FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Conc (MJ)",ProductionSystems,ProductionConditions,"Baseline");
Commod_OtherChar_MR(Regions,"AggregateFeedForageCrops_Commodity","Feed GE supply/demand ratio Forage",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Forage (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedForageCrops_Commodity","FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Forage (MJ)",ProductionSystems,ProductionConditions,"Baseline");
Commod_OtherChar_MR(Regions,"AggregateFeedGrass_Commodity","Feed GE supply/demand ratio Grass",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Grass (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedGrass_Commodity","FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Grass (MJ)",ProductionSystems,ProductionConditions,"Baseline");
Commod_OtherChar_MR(Regions,"AggregateFeedResidues_Commodity","Feed GE supply/demand ratio Residues",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Residues (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedResidues_Commodity","FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Residues (MJ)",ProductionSystems,ProductionConditions,"Baseline");
Commod_OtherChar_MR(Regions,"AggregateFeedTotal_Commodity","Feed GE supply/demand ratio Total",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedTotal_Commodity","FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline");
...
ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"Share in FeedGE_Req_Total from Conc",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Conc (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VActAnimalsHead_OtherChar_MR.l(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total from Conc (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Conc (MJ)",ProductionSystems,ProductionConditions,"Baseline");
ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"Share in FeedGE_Req_Total from Forage",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Forage (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VActAnimalsHead_OtherChar_MR.l(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total from Forage (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Forage (MJ)",ProductionSystems,ProductionConditions,"Baseline");
ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"Share in FeedGE_Req_Total from Grass",ProductionSystems,ProductionConditions,"Baseline")
                  $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Grass (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VActAnimalsHead_OtherChar_MR.l(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total from Grass (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                  /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Grass (MJ)",ProductionSystems,ProductionConditions,"Baseline");
ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"Share in FeedGE_Req_Total from Residues",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Residues (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VActAnimalsHead_OtherChar_MR.l(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total from Residues (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total from Residues (MJ)",ProductionSystems,ProductionConditions,"Baseline");
ActAnimalsHead_OtherChar_MR(Regions,Livestock,AnimalTypeInHerd,"Share in FeedGE_Req_Total",ProductionSystems,ProductionConditions,"Baseline")
                  $VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = VActAnimalsHead_OtherChar_MR.l(Regions,Livestock,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                  /VActAnimalsHead_OtherChar_MR.l(Regions,"All Animals","AllAndAverageTypes","FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline");
...
VCommod_Feed_MR.l(Regions,"AggregateFeedGrass_Commodity",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Grass,VCommod_Feed_MR.l(Regions,Commodities_Feed_Grass,ProductionSystems,ProductionConditions,"Baseline"));
VCommod_Feed_MR.l(Regions,"AggregateFeedCereals_Commodity",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Cereals,VCommod_Feed_MR.l(Regions,Commodities_Feed_Cereals,ProductionSystems,ProductionConditions,"Baseline"));

*and again summed over feed groups:
VCommod_Feed_MR.l(Regions,Commodities_FeedGroups_DetailedFeedingRations,ProductionSystems,ProductionConditions,"Baseline")
*                 $(NOT VCommod_Feed_MR.l(Regions,Commodities_FeedGroups_DetailedFeedingRations,ProductionSystems,ProductionConditions,"Baseline"))
         = sum(Commodities_Feed$Match_FeedCommodToFeedCommodGroups_DetailedFeedRatio(Commodities_Feed,Commodities_FeedGroups_DetailedFeedingRations),
                 VCommod_Feed_MR.l(Regions,Commodities_Feed,ProductionSystems,ProductionConditions,"Baseline"));

VCommod_Feed_Contents_MR.l(Regions,Commodities_FeedGroups_DetailedFeedingRations,Contents,ProductionSystems,ProductionConditions,"Baseline")
*                 $(NOT VCommod_Feed_Contents_MR.l(Regions,Commodities_FeedGroups_DetailledFeedingRations,Contents,ProductionSystems,ProductionConditions,"Baseline"))
         = sum(Commodities_Feed$Match_FeedCommodToFeedCommodGroups_DetailedFeedRatio(Commodities_Feed,Commodities_FeedGroups_DetailedFeedingRations),
                 VCommod_Feed_Contents_MR.l(Regions,Commodities_Feed,Contents,ProductionSystems,ProductionConditions,"Baseline"));
...
Commod_OtherChar_MR(Regions,Commodities_Feed_Grass,"DM share in relevant feed group",ProductionSystems,ProductionConditions,"Baseline")
                         $VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedGrass_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities_Feed_Grass,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                         /VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedGrass_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline");
Commod_OtherChar_MR(Regions,Commodities_Feed_ForageCrops,"DM share in relevant feed group",ProductionSystems,ProductionConditions,"Baseline")
                         $VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedForageCrops_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities_Feed_ForageCrops,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                         /VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedForageCrops_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline");
Commod_OtherChar_MR(Regions,Commodities_Feed_NoForageNoGrass,"DM share in relevant feed group",ProductionSystems,ProductionConditions,"Baseline")
                         $VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedNoForageNoGrass_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities_Feed_NoForageNoGrass,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                         /VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedNoForageNoGrass_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline");

*thus, for grass and forage, it looks as follows:
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Grass,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedGrass_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 *Commod_OtherChar_MR(Regions,Commodities_Feed_Grass,"DM share in relevant feed group",ProductionSystems,ProductionConditions,"Baseline");
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_ForageCrops,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 *Commod_OtherChar_MR(Regions,Commodities_Feed_ForageCrops,"DM share in relevant feed group",ProductionSystems,ProductionConditions,"Baseline");
...
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_NoForageNoGrass,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedConcentrates_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 *Commod_OtherChar_MR(Regions,Commodities_Feed_NoForageNoGrass,"DM share in relevant feed group",ProductionSystems,ProductionConditions,"Baseline");
...
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_FeedGroups_DetailedFeedingRations,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed$Match_FeedCommodToFeedCommodGroups_DetailedFeedRatio(Commodities_Feed,Commodities_FeedGroups_DetailedFeedingRations),
                 FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"));
...
FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,Commodities_Feed_Cereals,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 $FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,Commodities_Feed_Cereals,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 *0.75*(FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                                 +FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,"AggregateFeedOilCropsAndCakes_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"))
                 /FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,Commodities_Feed_OilCropsAndCakes,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 $FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,"AggregateFeedOilCropsAndCakes_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,Commodities_Feed_OilCropsAndCakes,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 *0.25*(FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                                 +FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,"AggregateFeedOilCropsAndCakes_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"))
                 /FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",AnimalTypeInHerd,"AggregateFeedOilCropsAndCakes_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,Commodities_Feed_Cereals,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 $FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,Commodities_Feed_Cereals,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 *0.60*(FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                                 +FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,"AggregateFeedOilCropsAndCakes_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"))
                 /FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,Commodities_Feed_OilCropsAndCakes,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 $FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,"AggregateFeedOilCropsAndCakes_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,Commodities_Feed_OilCropsAndCakes,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 *0.40*(FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                                 +FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,"AggregateFeedOilCropsAndCakes_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"))
                 /FeedingRationsHeads_OtherChar_MR(Regions,"Chickens",AnimalTypeInHerd,"AggregateFeedOilCropsAndCakes_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline");

*adjust milk products:
FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",PigTypeInHerd,"Whey","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",PigTypeInHerd,"Whey","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 + FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",PigTypeInHerd,"Milk, whole","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 + FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",PigTypeInHerd,"Milk, skimmed","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",PigTypeInHerd,"Milk, whole","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline") = 0;
FeedingRationsHeads_OtherChar_MR(Regions,"Pigs",PigTypeInHerd,"Milk, skimmed","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline") = 0;

FeedingRationsHeads_OtherChar_MR(Regions,"Chickens","AllAndAverageTypes","Soyabean cake","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,"Chickens","AllAndAverageTypes","Soyabean cake","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 + FeedingRationsHeads_OtherChar_MR(Regions,"Chickens","AllAndAverageTypes","Whey","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 + FeedingRationsHeads_OtherChar_MR(Regions,"Chickens","AllAndAverageTypes","Milk, whole","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 + FeedingRationsHeads_OtherChar_MR(Regions,"Chickens","AllAndAverageTypes","Milk, skimmed","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRationsHeads_OtherChar_MR(Regions,"Chickens","AllAndAverageTypes","Whey","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline") = 0;
FeedingRationsHeads_OtherChar_MR(Regions,"Chickens","AllAndAverageTypes","Milk, whole","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline") = 0;
FeedingRationsHeads_OtherChar_MR(Regions,"Chickens","AllAndAverageTypes","Milk, skimmed","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline") = 0;
...
*while assigning aggregate feed categories to single commodities, it can happen that no data for feed availability is given (e.g. for forage in Afghanistan) and thus no values are assigned,
*thus assign those specifically, if needed: do this for forage, this will cover most cases, assigning half to other grasses, half to legumes nes:
*use the aggregates above to identify where it is needed:
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"Other grasses, for forage","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 $((NOT FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"))
                         AND FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"))
         = FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")/2;
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"Leguminous Nes,For+Sil","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 $((NOT FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"))
                         AND FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"))
         = FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedForageCrops_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")/2;

*residues are missing both in supply values an therefore also in per head feeding rations.
*Thus assign residues in per head commodity specific feeding rations to "Straw husks":
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"Straw husks","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedResidues_Commodity","Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline");
...
*Thus, feed supply data may be missing, but feeding ration data is then available on detailed level also for those commodities where supply is missing
...
FeedingRations_Contents_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_QuantityActUnits_MR.l(Regions,Activities,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
         = Commod_Contents_MR(Regions,Commodities_Feed,"FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline");
FeedingRations_Contents_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 $VActAnimalsHead_QuantityActUnits_MR.l(Regions,Activities,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
         = Commod_Contents_MR(Regions,Commodities_Feed,"FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"GE per ton DM feeding ration (MJ/t DM)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                 *FeedingRations_Contents_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedTotal_Commodity","GE per ton DM feeding ration (MJ/t DM)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed,
                 FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"GE per ton DM feeding ration (MJ/t DM)",ProductionSystems,ProductionConditions,"Baseline"));

FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"GE share in feeding ration (share in MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 $FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedTotal_Commodity","GE per ton DM feeding ration (MJ/t DM)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"GE per ton DM feeding ration (MJ/t DM)",ProductionSystems,ProductionConditions,"Baseline")
                 /FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedTotal_Commodity","GE per ton DM feeding ration (MJ/t DM)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedQuant_Req (t)",ProductionSystems,ProductionConditions,"Baseline")
                 $FeedingRations_Contents_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = ActAnimalsHead_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 *FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"GE share in feeding ration (share in MJ)",ProductionSystems,ProductionConditions,"Baseline")
                         /FeedingRations_Contents_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedGE (MJ)",ProductionSystems,ProductionConditions,"Baseline");
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                 $FeedingRations_Contents_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline")
         = ActAnimalsHead_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"FeedGE_Req_Total (MJ)",ProductionSystems,ProductionConditions,"Baseline")
                 *FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"GE share in feeding ration (share in MJ)",ProductionSystems,ProductionConditions,"Baseline")
                         /FeedingRations_Contents_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedGE in DM (MJ)",ProductionSystems,ProductionConditions,"Baseline");
...
VFeedingRations_Quantity_MR.l(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedQuant_Req (t)",ProductionSystems,ProductionConditions,"Baseline")
                 *VActAnimalsHead_QuantityActUnits_MR.l(Regions,Activities,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline");
VFeedingRations_Contents_MR.l(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                 *VActAnimalsHead_QuantityActUnits_MR.l(Regions,Activities,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline");


*total requirement
VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_Feed,ProductionSystems,ProductionConditions,"Baseline")
         = sum((Livestock,AnimalTypeInHerd),
                 VFeedingRations_Quantity_MR.l(Regions,Livestock,AnimalTypeInHerd,Commodities_Feed,ProductionSystems,ProductionConditions,"Baseline"));
VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes","AggregateFeedGrass_Commodity",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Grass,VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_Feed_Grass,ProductionSystems,ProductionConditions,"Baseline"));
VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes","AggregateFeedCereals_Commodity",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Cereals,VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_Feed_Cereals,ProductionSystems,ProductionConditions,"Baseline"));

VFeedingRations_Quantity_MR.l(Regions,Activities,AnimalTypeInHerd,"AggregateFeedGrass_Commodity",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Grass,VFeedingRations_Quantity_MR.l(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Grass,ProductionSystems,ProductionConditions,"Baseline"));
VFeedingRations_Quantity_MR.l(Regions,Activities,AnimalTypeInHerd,"AggregateFeedCereals_Commodity",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Cereals,VFeedingRations_Quantity_MR.l(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Cereals,ProductionSystems,ProductionConditions,"Baseline"));

*total req in DM.
VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_Feed,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum((Livestock,AnimalTypeInHerd),
                 VFeedingRations_Contents_MR.l(Regions,Livestock,AnimalTypeInHerd,Commodities_Feed,"DM (t)",ProductionSystems,ProductionConditions,"Baseline"));
VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes","AggregateFeedGrass_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Grass,VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_Feed_Grass,"DM (t)",ProductionSystems,ProductionConditions,"Baseline"));
VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes","AggregateFeedCereals_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Cereals,VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_Feed_Cereals,"DM (t)",ProductionSystems,ProductionConditions,"Baseline"));

VFeedingRations_Contents_MR.l(Regions,Activities,AnimalTypeInHerd,"AggregateFeedGrass_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Grass,VFeedingRations_Contents_MR.l(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Grass,"DM (t)",ProductionSystems,ProductionConditions,"Baseline"));
VFeedingRations_Contents_MR.l(Regions,Activities,AnimalTypeInHerd,"AggregateFeedCereals_Commodity","DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Cereals,VFeedingRations_Contents_MR.l(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Cereals,"DM (t)",ProductionSystems,ProductionConditions,"Baseline"));



VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_FeedGroups_DetailedFeedingRations,ProductionSystems,ProductionConditions,"Baseline")
*                 $(NOT VCommod_Feed_Contents_MR.l(Regions_MR,Commodities_FeedGroups_DetailledFeedingRations,Contents,ProductionSystems,ProductionConditions,"Baseline))
         = sum(Commodities_Feed$Match_FeedCommodToFeedCommodGroups_DetailedFeedRatio(Commodities_Feed,Commodities_FeedGroups_DetailedFeedingRations),
                 VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_Feed,ProductionSystems,ProductionConditions,"Baseline"));

VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_FeedGroups_DetailedFeedingRations,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
*                 $(NOT VCommod_Feed_Contents_MR.l(Regions_MR,Commodities_FeedGroups_DetailledFeedingRations,Contents,ProductionSystems,ProductionConditions,"Baseline))
         = sum(Commodities_Feed$Match_FeedCommodToFeedCommodGroups_DetailedFeedRatio(Commodities_Feed,Commodities_FeedGroups_DetailedFeedingRations),
                 VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities_Feed,"DM (t)",ProductionSystems,ProductionConditions,"Baseline"));


FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedGrass_Commodity","Quantity share in total feed req of all animals",ProductionSystems,ProductionConditions,"Baseline")
                 $VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes","AggregateFeedGrass_Commodity",ProductionSystems,ProductionConditions,"Baseline")
         = VFeedingRations_Quantity_MR.l(Regions,Activities,AnimalTypeInHerd,"AggregateFeedGrass_Commodity",ProductionSystems,ProductionConditions,"Baseline")
                 /VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes","AggregateFeedGrass_Commodity",ProductionSystems,ProductionConditions,"Baseline");

FeedingRations_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in total feed req of all animals",ProductionSystems,ProductionConditions,"Baseline")
                 $VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes","AggregateFeedCereals_Commodity",ProductionSystems,ProductionConditions,"Baseline")
         = VFeedingRations_Quantity_MR.l(Regions,Activities,AnimalTypeInHerd,"AggregateFeedCereals_Commodity",ProductionSystems,ProductionConditions,"Baseline")
                 /VFeedingRations_Quantity_MR.l(Regions,"All Animals","AllAndAverageTypes","AggregateFeedCereals_Commodity",ProductionSystems,ProductionConditions,"Baseline");


FeedingRations_OtherChar_MR(Regions,"All NonRuminants","AllAndAverageTypes","AggregateFeedCereals_Commodity","Quantity share in total feed req of all animals",ProductionSystems,ProductionConditions,"Baseline")
         = sum((NonRuminants,AnimalTypeInherd),FeedingRations_OtherChar_MR(Regions,NonRuminants,AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in total feed req of all animals",ProductionSystems,ProductionConditions,"Baseline"));
FeedingRations_OtherChar_MR(Regions,"All Ruminants","AllAndAverageTypes","AggregateFeedCereals_Commodity","Quantity share in total feed req of all animals",ProductionSystems,ProductionConditions,"Baseline")
         = sum((Ruminants,AnimalTypeInherd),FeedingRations_OtherChar_MR(Regions,Ruminants,AnimalTypeInHerd,"AggregateFeedCereals_Commodity","Quantity share in total feed req of all animals",ProductionSystems,ProductionConditions,"Baseline"));
...
Commod_OtherChar_MR(Regions,Commodities,"Feed DM supply/demand ratio",ProductionSystems,ProductionConditions,"Baseline")
                 $VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                 /VFeedingRations_Contents_MR.l(Regions,"All Animals","AllAndAverageTypes",Commodities,"DM (t)",ProductionSystems,ProductionConditions,"Baseline");

FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedGrass_Commodity","FeedQuant_Req (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Grass,FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Grass,"FeedQuant_Req (t)",ProductionSystems,ProductionConditions,"Baseline"));
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedCereals_Commodity","FeedQuant_Req (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Cereals,FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Cereals,"FeedQuant_Req (t)",ProductionSystems,ProductionConditions,"Baseline"));

FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedGrass_Commodity","FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Grass,FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Grass,"FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline"));
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,"AggregateFeedCereals_Commodity","FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Cereals,FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed_Cereals,"FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline"));
...
VCommod_Feed_Contents_MR.l(Regions,Commodities_Feed,"FeedQuant DM (t) - left after feeding ruminants",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,Commodities_Feed,"DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                 -sum((Ruminants,AnimalTypeInHerd),
                         VActAnimalsHead_QuantityActUnits_MR.l(Regions,Ruminants,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
                                 *FeedingRationsHeads_OtherChar_MR(Regions,Ruminants,AnimalTypeInHerd,Commodities_Feed,"FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline")
                                         *Commod_OtherChar_MR(Regions,Commodities_Feed,"Feed DM supply/demand ratio",ProductionSystems,ProductionConditions,"Baseline"));
VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedCereals_Commodity","FeedQuant DM (t) - left after feeding ruminants",ProductionSystems,ProductionConditions,"Baseline")
         = sum(Commodities_Feed_Cereals,
                 VCommod_Feed_Contents_MR.l(Regions,Commodities_Feed_Cereals,"FeedQuant DM (t) - left after feeding ruminants",ProductionSystems,ProductionConditions,"Baseline"));


VFeedingRations_OtherChar_MR.l(Regions,"All NonRuminants","AllAndAverageTypes","AggregateFeedCereals_Commodity","FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         =sum((NoNRuminants,AnimalTypeInHerd,Commodities_Feed_Cereals),
                 VActAnimalsHead_QuantityActUnits_MR.l(Regions,NoNRuminants,AnimalTypeInHerd,ProductionSystems,ProductionConditions,"Baseline")
                         *FeedingRationsHeads_OtherChar_MR(Regions,NoNRuminants,AnimalTypeInHerd,Commodities_Feed_Cereals,"FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline"));


Commod_OtherChar_MR(Regions,"AggregateFeedCereals_Commodity","Feed DM supply/demand ratio - left after feeding ruminants",ProductionSystems,ProductionConditions,"Baseline")
                 $VFeedingRations_OtherChar_MR.l(Regions,"All NonRuminants","AllAndAverageTypes","AggregateFeedCereals_Commodity","FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline")
         = VCommod_Feed_Contents_MR.l(Regions,"AggregateFeedCereals_Commodity","FeedQuant DM (t) - left after feeding ruminants",ProductionSystems,ProductionConditions,"Baseline")
                 /VFeedingRations_OtherChar_MR.l(Regions,"All NonRuminants","AllAndAverageTypes","AggregateFeedCereals_Commodity","FeedQuant_Req DM (t)",ProductionSystems,ProductionConditions,"Baseline");

PUTCLOSE con "   End _V6_BaselineValues_ForModelRuns:   1" timeElapsed;

*here, assign the single crop detailed feeding rations to the scenarios where there is already data on group-specific feeding rations (e.g. UNISECO scenarios):
*otherwise, the crop-specific values are taken from the baseline, the group specific from these scenarios:
FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,Scenarios)
         =sum(Commodities_FeedGroups_DetailedFeedingRations_NoTot$(Match_FeedCommodToFeedCommodGroups_DetailedFeedRatio(Commodities_Feed,Commodities_FeedGroups_DetailedFeedingRations_NoTot)
                         AND FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_FeedGroups_DetailedFeedingRations_NoTot,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")),
                 FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_Feed,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline")
                         *FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_FeedGroups_DetailedFeedingRations_NoTot,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,Scenarios)
                                 /FeedingRationsHeads_OtherChar_MR(Regions,Activities,AnimalTypeInHerd,Commodities_FeedGroups_DetailedFeedingRations_NoTot,"Quantity share in DM (share)",ProductionSystems,ProductionConditions,"Baseline"));



PUTCLOSE con "   End _V6_BaselineValues_ForModelRuns:   2" timeElapsed;
...
*the differentiation for the different grassland activities is retained
