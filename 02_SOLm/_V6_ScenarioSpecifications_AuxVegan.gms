...
*0a) Assign country values
*************************************************************************************************************************************************
CropRotationShare(Countries, "All_cereals1_V","Organic","%Scenario%") =  0.05;
CropRotationShare(Countries, "All_cereals2_V","Organic","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_pulses_V","Organic","%Scenario%") =  0.35;
CropRotationShare(Countries, "All_oilCrops_V","Organic","%Scenario%") =  0.2;
CropRotationShare(Countries, "All starchy roots","Organic","%Scenario%") =  0.01;
CropRotationShare(Countries, "All Vegetables","Organic","%Scenario%") = 0.16;
CropRotationShare(Countries, "All_fruits_V","Organic","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_setAside_V","Organic","%Scenario%") =  0.23;

*assign the values for the non-vegan groups:
CropRotationShare(Countries, "All_cereals2_NonV","Organic","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_StarchyRoots_NonV","Organic","%Scenario%") = 0.01;

*although the sets are the same, we also need the potentially different shares for the Non-Vegan groups (see below):
CropRotationShare(Countries, "All_cereals1_NonV","Organic","%Scenario%") =  0.05;
CropRotationShare(Countries, "All_pulses_NonV","Organic","%Scenario%") =  0.35;
CropRotationShare(Countries, "All_oilCrops_NonV","Organic","%Scenario%") =  0.2;
CropRotationShare(Countries, "All Vegetables_NonV","Organic","%Scenario%") = 0.16;
CropRotationShare(Countries, "All_fruits_NonV","Organic","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_setAside_NonV","Organic","%Scenario%") =  0.23;
...
*0a) Assign country values
*************************************************************************************************************************************************
CropRotationShare(Countries, "All_cereals1_V","Convent","%Scenario%") =  0.1;
CropRotationShare(Countries, "All_cereals2_V","Convent","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_pulses_V","Convent","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_oilCrops_V","Convent","%Scenario%") =  0.35;
CropRotationShare(Countries, "All starchy roots","Convent","%Scenario%") =  0.0;
CropRotationShare(Countries, "All Vegetables","Convent","%Scenario%") = 0.55;
CropRotationShare(Countries, "All_fruits_V","Convent","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_setAside_V","Convent","%Scenario%") =  0.0;

*assign the values for the non-vegan groups:
*This is not needed, as the these new convent crop rot shares are applied on the areas freed due to vegan shares only:
$ontext;
CropRotationShare(Countries, "All_cereals2_NonV","Convent","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_StarchyRoots_NonV","Convent","%Scenario%") = 0.0;

*although the sets are the same, we also need the potentially different shares for the Non-Vegan groups (see below):
CropRotationShare(Countries, "All_cereals1_NonV","Convent","%Scenario%") =  0.1;
CropRotationShare(Countries, "All_pulses_NonV","Convent","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_oilCrops_NonV","Convent","%Scenario%") =  0.35;
CropRotationShare(Countries, "All Vegetables_NonV","Convent","%Scenario%") = 0.55;
CropRotationShare(Countries, "All_fruits_NonV","Convent","%Scenario%") =  0.0;
CropRotationShare(Countries, "All_setAside_NonV","Convent","%Scenario%") =  0.0;
$offtext;


*********************for conventional: crop rotation shares on individual crop level************************

*further down, there is a default calculation for conventional crop shares and a specific one for organic
*the latter entails assignment of single crop activity levels within activity groups - hence no need to have crop rot shares on single crop activity level
*the former however works on single crop level, hence the need to already derive here single crop level crop rot shares for conventional:
*thus, do as follows:
...
CropRotationShare(Countries,Cereals1_V,"Convent","%Scenario%")
                 $VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Cereals1_V","AllProdSyst","AllProdCond","FOFA_BAU_2050")
         = CropRotationShare(Countries, "All_cereals1_V","Convent","%Scenario%")
                 *VActCropsGrass_QuantityActUnits_MR.l(COuntries,Cereals1_V,"AllProdSyst","AllProdCond","FOFA_BAU_2050")
                          /VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Cereals1_V","AllProdSyst","AllProdCond","FOFA_BAU_2050");
CropRotationShare(Countries,Cereals2_V,"Convent","%Scenario%")
                 $VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Cereals2_V","AllProdSyst","AllProdCond","FOFA_BAU_2050")
         = CropRotationShare(Countries, "All_cereals2_V","Convent","%Scenario%")
                 *VActCropsGrass_QuantityActUnits_MR.l(COuntries,Cereals2_V,"AllProdSyst","AllProdCond","FOFA_BAU_2050")
                          /VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Cereals2_V","AllProdSyst","AllProdCond","FOFA_BAU_2050");
CropRotationShare(Countries,Pulses_V,"Convent","%Scenario%")
                 $VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Pulses_V","AllProdSyst","AllProdCond","FOFA_BAU_2050")
         = CropRotationShare(Countries, "All_Pulses_V","Convent","%Scenario%")
                 *VActCropsGrass_QuantityActUnits_MR.l(COuntries,Pulses_V,"AllProdSyst","AllProdCond","FOFA_BAU_2050")
                          /VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Pulses_V","AllProdSyst","AllProdCond","FOFA_BAU_2050");
CropRotationShare(Countries,Oilcrops_V,"Convent","%Scenario%")
                 $VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Oilcrops_V","AllProdSyst","AllProdCond","FOFA_BAU_2050")
         = CropRotationShare(Countries, "All_Oilcrops_V","Convent","%Scenario%")
                 *VActCropsGrass_QuantityActUnits_MR.l(COuntries,Oilcrops_V,"AllProdSyst","AllProdCond","FOFA_BAU_2050")
                          /VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Oilcrops_V","AllProdSyst","AllProdCond","FOFA_BAU_2050");
CropRotationShare(Countries,StarchyRoots,"Convent","%Scenario%")
                 $VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL starchy roots","AllProdSyst","AllProdCond","FOFA_BAU_2050")
         = CropRotationShare(Countries, "All starchy roots","Convent","%Scenario%")
                 *VActCropsGrass_QuantityActUnits_MR.l(COuntries,StarchyRoots,"AllProdSyst","AllProdCond","FOFA_BAU_2050")
                          /VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL starchy roots","AllProdSyst","AllProdCond","FOFA_BAU_2050");
CropRotationShare(Countries,Vegetables,"Convent","%Scenario%")
                 $VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL Vegetables","AllProdSyst","AllProdCond","FOFA_BAU_2050")
         = CropRotationShare(Countries, "All Vegetables","Convent","%Scenario%")
                 *VActCropsGrass_QuantityActUnits_MR.l(COuntries,Vegetables,"AllProdSyst","AllProdCond","FOFA_BAU_2050")
                          /VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL Vegetables","AllProdSyst","AllProdCond","FOFA_BAU_2050");
CropRotationShare(Countries,Fruits_V,"Convent","%Scenario%")
                 $VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Fruits_V","AllProdSyst","AllProdCond","FOFA_BAU_2050")
         = CropRotationShare(Countries, "All_Fruits_V","Convent","%Scenario%")
                 *VActCropsGrass_QuantityActUnits_MR.l(COuntries,Fruits_V,"AllProdSyst","AllProdCond","FOFA_BAU_2050")
                          /VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_Fruits_V","AllProdSyst","AllProdCond","FOFA_BAU_2050");
CropRotationShare(Countries,SetAside_V,"Convent","%Scenario%")
                 $VActCropsGrass_QuantityActUnits_MR.l(COuntries,"ALL_SetAside_V","AllProdSyst","AllProdCond","FOFA_BAU_2050")
         = CropRotationShare(Countries, "All_SetAside_V","Convent","%Scenario%")
                 *VActCropsGrass_QuantityActUnits_MR.l(COuntries,SetAside_V,"AllProdSyst","AllProdCond","FOFA_BAU_2050")
                          /VActCropsGrass_QuantityActUnits_MR.l(Countries,"ALL_SetAside_V","AllProdSyst","AllProdCond","FOFA_BAU_2050");
...
*********** Split activity areas in organic and conventional part*******************************
...
*********** caculate crop rotation shares for BAU crop rotation *******************************

*2.0) derive the shares of crops in fully vegan cropping patterns for conventional area
*to be used if no other assignments for convent crop rotations are made (as e.g. for the optimized crop rotations)
...
*********** calculate crop rot share for conv (if not yet assigned)************************
*$ifthen %CropRotationDesign% == "BAU" 
$if %CropRotationDesign% == "Optimized" $goto DoNotAssignBAUCropRot
...
CropRotationShare(Regions_MR,CropsUsedInRotations_V,"Convent","%Scenario%")
                 $(VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"All Crops used in crop rotations_V","Convent","AllProdCond","%Scenario%")
                         AND (NOT CropRotationShare(Regions_MR,CropsUsedInRotations_V,"Convent","%Scenario%")))
         = VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,CropsUsedInRotations_V,"Convent","AllProdCond","%Scenario%")
                 /VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"All Crops used in crop rotations_V","Convent","AllProdCond","%Scenario%");


*$endif;
$label DoNotAssignBAUCropRot

*********** assign the values for conventional areas newly *******************************
...
*********** caculate areas for feed utilization (with parameter v)  *******************************
...
*********** caculate total for feed utilization & assign to conservation or cropland (according to u) *******************************
...
VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"Alternative use - Cropland",ProdSyst_OrgCon,ProductionConditions,"%Scenario%")
         = VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"Alternative use",ProdSyst_OrgCon,ProductionConditions,"%Scenario%")
                 *CropUSeOfNewlyFreeAreas("World","AllProdSyst","%Scenario%");
VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"Alternative use - Conservation",ProdSyst_OrgCon,ProductionConditions,"%Scenario%")
         = VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"Alternative use",ProdSyst_OrgCon,ProductionConditions,"%Scenario%")
...
VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"All Crops used in crop rotations_NonV","AllProdSyst",ProductionConditions,"FOFA_BAU_2050")
         = Sum(CropsUsedInRotations_NonV,
                 VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,CropsUsedInRotations_NonV,"AllProdSyst",ProductionConditions,"FOFA_BAU_2050"));
*now we need the AllProdSyst of the different uses:
VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"Alternative use - Cropland","AllProdSyst",ProductionConditions,"%Scenario%")
         = VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"Alternative use - Cropland","Convent",ProductionConditions,"%Scenario%")
...
VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"Alternative use - Conservation","AllProdSyst",ProductionConditions,"%Scenario%")
         = VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"Alternative use - Conservation","Convent",ProductionConditions,"%Scenario%")
...
*********** caculate for conventional: Area = all areas *v* cropRotShare + .... *******************************


*first do the conventional areas:
VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,CropsUsedInRotations_V,"Convent",ProductionConditions,"%Scenario%")
         = VActCropsGrass_QuantityActUnits_MR.l(Regions_MR,"All Crops used in crop rot_NonV - w/o areas not used","Convent",ProductionConditions,"%Scenario%")
                 *VeganDietShare("World","%Scenario%")
                          *CropRotationShare(Regions_MR,CropsUsedInRotations_V,"Convent","%Scenario%");
...
*********** caculate for organic areas: Area according to crop rot share *******************************


*and now the organic areas:
*- organic areas per crop (after reduction of feed use areas): change to organic non-vegan crop rotations - on a share corresponding to (1-veganshare) of the original TOTAL cropland area incl. feed
*         (indicated by the term "NonV" in the names of sets and elements) - still contains forage maize and triticale in Cereals2, etc.
*- organic areas per crop (after reduction of feed use areas): change to organic-vegan crop rotations - on a share corresponding to the remainder of the areas not freed from reduced feed production
*- Organic areas - AlternativeUse: Assign to single crops according to organic-vegan crop rotations
